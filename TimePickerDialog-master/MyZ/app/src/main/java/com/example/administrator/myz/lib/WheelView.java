package com.example.administrator.myz.lib;
...
import com.example.administrator.myz.R;
import com.example.administrator.myz.adapter.WheelAdapter;
import com.example.administrator.myz.listener.OnItemSelectedListener;
...
public class WheelView extends View
{
	...
	protected void onDraw(Canvas canvas)
	{
		...
		// 中间两条横线
		canvas.drawLine(0.0F, firstLineY-15, measuredWidth, firstLineY-15, paintIndicator);
		canvas.drawLine(0.0F, secondLineY+15, measuredWidth, secondLineY+15, paintIndicator);
		// 单位的Label
		if (label != null)
		{
