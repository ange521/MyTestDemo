package com.example.administrator.myz.view;
...
import com.example.administrator.myz.listener.OnDismissListener;
import com.example.administrator.myz.utils.PickerViewAnimateUtil;
...
public class BasePickerView
{
	...
	public void dismiss()
	{
        ...
        Log.d("----------","-----------22===="+decorView.hasFocusable());
		setIsFocus(decorView.hasFocusable());
		isDismissing = true;
	}
